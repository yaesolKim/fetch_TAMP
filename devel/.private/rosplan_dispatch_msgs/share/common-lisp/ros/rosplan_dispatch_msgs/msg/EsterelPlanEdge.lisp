...
(cl:ensure-generic-function 'edge_type-val :lambda-list '(m))
(cl:defmethod edge_type-val ((m <EsterelPlanEdge>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosplan_dispatch_msgs-msg:edge_type-val is deprecated.  Use rosplan_dispatch_msgs-msg:edge_type instead.")
  (edge_type m))
...
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<EsterelPlanEdge>)))
    "Constants for message type '<EsterelPlanEdge>"
  '((:CONDITION_EDGE . 0)
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <EsterelPlanEdge>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'edge_type)) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EsterelPlanEdge>) istream)
  "Deserializes a message object of type '<EsterelPlanEdge>"
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'edge_type)) (cl:read-byte istream))
    (cl:let ((unsigned 0))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<EsterelPlanEdge>)))
  ...
  "1d2c55d97ec5947580a42b9057d254ce")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'EsterelPlanEdge)))
  "Returns md5sum for a message object of type 'EsterelPlanEdge"
  "1d2c55d97ec5947580a42b9057d254ce")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EsterelPlanEdge>)))
  ...
  (cl:format cl:nil "#EsterelPlanEdge message~%~%byte CONDITION_EDGE   = 0~%byte START_END_ACTION_EDGE = 1~%byte INTERFERENCE_EDGE = 2~%~%byte edge_type~%int32 edge_id~%string edge_name~%int32 signal_type~%int32[] source_ids~%int32[] sink_ids~%float64 duration_lower_bound~%float64 duration_upper_bound~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EsterelPlanEdge)))
  "Returns full string definition for message of type 'EsterelPlanEdge"
  (cl:format cl:nil "#EsterelPlanEdge message~%~%byte CONDITION_EDGE   = 0~%byte START_END_ACTION_EDGE = 1~%byte INTERFERENCE_EDGE = 2~%~%byte edge_type~%int32 edge_id~%string edge_name~%int32 signal_type~%int32[] source_ids~%int32[] sink_ids~%float64 duration_lower_bound~%float64 duration_upper_bound~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <EsterelPlanEdge>))
  ...
  (cl:list 'EsterelPlanEdge
    (cl:cons ':edge_type (edge_type msg))
