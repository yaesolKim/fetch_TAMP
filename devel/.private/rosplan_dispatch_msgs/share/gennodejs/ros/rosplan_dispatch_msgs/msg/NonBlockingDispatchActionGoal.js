...
class NonBlockingDispatchActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new NonBlockingDispatchGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = NonBlockingDispatchGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new NonBlockingDispatchActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = NonBlockingDispatchGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new NonBlockingDispatchActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = NonBlockingDispatchGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new NonBlockingDispatchGoal()
    }
...
module.exports = NonBlockingDispatchActionGoal;
