...
class DomainOperator {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.at_start_comparison = null;
      this.at_end_comparison = null;
      this.over_all_comparison = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('at_start_comparison')) {
        this.at_start_comparison = initObj.at_start_comparison
      }
      else {
        this.at_start_comparison = [];
      }
      if (initObj.hasOwnProperty('at_end_comparison')) {
        this.at_end_comparison = initObj.at_end_comparison
      }
      else {
        this.at_end_comparison = [];
      }
      if (initObj.hasOwnProperty('over_all_comparison')) {
        this.over_all_comparison = initObj.over_all_comparison
      }
      else {
        this.over_all_comparison = [];
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [at_start_comparison]
    // Serialize the length for message field [at_start_comparison]
    bufferOffset = _serializer.uint32(obj.at_start_comparison.length, buffer, bufferOffset);
    obj.at_start_comparison.forEach((val) => {
      bufferOffset = DomainInequality.serialize(val, buffer, bufferOffset);
    });
    // Serialize message field [at_end_comparison]
    // Serialize the length for message field [at_end_comparison]
    bufferOffset = _serializer.uint32(obj.at_end_comparison.length, buffer, bufferOffset);
    obj.at_end_comparison.forEach((val) => {
      bufferOffset = DomainInequality.serialize(val, buffer, bufferOffset);
    });
    // Serialize message field [over_all_comparison]
    // Serialize the length for message field [over_all_comparison]
    bufferOffset = _serializer.uint32(obj.over_all_comparison.length, buffer, bufferOffset);
    obj.over_all_comparison.forEach((val) => {
      bufferOffset = DomainInequality.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [at_start_comparison]
    // Deserialize array length for message field [at_start_comparison]
    len = _deserializer.uint32(buffer, bufferOffset);
    data.at_start_comparison = new Array(len);
    for (let i = 0; i < len; ++i) {
      data.at_start_comparison[i] = DomainInequality.deserialize(buffer, bufferOffset)
    }
    // Deserialize message field [at_end_comparison]
    // Deserialize array length for message field [at_end_comparison]
    len = _deserializer.uint32(buffer, bufferOffset);
    data.at_end_comparison = new Array(len);
    for (let i = 0; i < len; ++i) {
      data.at_end_comparison[i] = DomainInequality.deserialize(buffer, bufferOffset)
    }
    // Deserialize message field [over_all_comparison]
    // Deserialize array length for message field [over_all_comparison]
    len = _deserializer.uint32(buffer, bufferOffset);
    data.over_all_comparison = new Array(len);
    for (let i = 0; i < len; ++i) {
      data.over_all_comparison[i] = DomainInequality.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.at_start_comparison.forEach((val) => {
      length += DomainInequality.getMessageSize(val);
    });
    object.at_end_comparison.forEach((val) => {
      length += DomainInequality.getMessageSize(val);
    });
    object.over_all_comparison.forEach((val) => {
      length += DomainInequality.getMessageSize(val);
    });
    return length + 64;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.at_start_comparison !== undefined) {
      resolved.at_start_comparison = new Array(msg.at_start_comparison.length);
      for (let i = 0; i < resolved.at_start_comparison.length; ++i) {
        resolved.at_start_comparison[i] = DomainInequality.Resolve(msg.at_start_comparison[i]);
      }
    }
    else {
      resolved.at_start_comparison = []
    }

    if (msg.at_end_comparison !== undefined) {
      resolved.at_end_comparison = new Array(msg.at_end_comparison.length);
      for (let i = 0; i < resolved.at_end_comparison.length; ++i) {
        resolved.at_end_comparison[i] = DomainInequality.Resolve(msg.at_end_comparison[i]);
      }
    }
    else {
      resolved.at_end_comparison = []
    }

    if (msg.over_all_comparison !== undefined) {
      resolved.over_all_comparison = new Array(msg.over_all_comparison.length);
      for (let i = 0; i < resolved.over_all_comparison.length; ++i) {
        resolved.over_all_comparison[i] = DomainInequality.Resolve(msg.over_all_comparison[i]);
      }
    }
    else {
      resolved.over_all_comparison = []
    }
