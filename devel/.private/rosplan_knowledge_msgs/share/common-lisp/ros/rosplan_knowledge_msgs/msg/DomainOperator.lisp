...
(cl:defclass <DomainOperator> (roslisp-msg-protocol:ros-message)
  ((formula
   ...
   :initform (cl:make-array 0 :element-type 'rosplan_knowledge_msgs-msg:DomainFormula :initial-element (cl:make-instance 'rosplan_knowledge_msgs-msg:DomainFormula)))
   (at_start_comparison
    :reader at_start_comparison
    :initarg :at_start_comparison
    :type (cl:vector rosplan_knowledge_msgs-msg:DomainInequality)
   :initform (cl:make-array 0 :element-type 'rosplan_knowledge_msgs-msg:DomainInequality :initial-element (cl:make-instance 'rosplan_knowledge_msgs-msg:DomainInequality)))
   (at_end_comparison
    :reader at_end_comparison
    :initarg :at_end_comparison
    :type (cl:vector rosplan_knowledge_msgs-msg:DomainInequality)
   :initform (cl:make-array 0 :element-type 'rosplan_knowledge_msgs-msg:DomainInequality :initial-element (cl:make-instance 'rosplan_knowledge_msgs-msg:DomainInequality)))
   (over_all_comparison
    :reader over_all_comparison
    :initarg :over_all_comparison
    :type (cl:vector rosplan_knowledge_msgs-msg:DomainInequality)
   :initform (cl:make-array 0 :element-type 'rosplan_knowledge_msgs-msg:DomainInequality :initial-element (cl:make-instance 'rosplan_knowledge_msgs-msg:DomainInequality))))
)
...
(cl:ensure-generic-function 'at_start_comparison-val :lambda-list '(m))
(cl:defmethod at_start_comparison-val ((m <DomainOperator>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosplan_knowledge_msgs-msg:at_start_comparison-val is deprecated.  Use rosplan_knowledge_msgs-msg:at_start_comparison instead.")
  (at_start_comparison m))

(cl:ensure-generic-function 'at_end_comparison-val :lambda-list '(m))
(cl:defmethod at_end_comparison-val ((m <DomainOperator>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosplan_knowledge_msgs-msg:at_end_comparison-val is deprecated.  Use rosplan_knowledge_msgs-msg:at_end_comparison instead.")
  (at_end_comparison m))

(cl:ensure-generic-function 'over_all_comparison-val :lambda-list '(m))
(cl:defmethod over_all_comparison-val ((m <DomainOperator>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosplan_knowledge_msgs-msg:over_all_comparison-val is deprecated.  Use rosplan_knowledge_msgs-msg:over_all_comparison instead.")
  (over_all_comparison m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <DomainOperator>) ostream)
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'at_start_comparison))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (roslisp-msg-protocol:serialize ele ostream))
   (cl:slot-value msg 'at_start_comparison))
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'at_end_comparison))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (roslisp-msg-protocol:serialize ele ostream))
   (cl:slot-value msg 'at_end_comparison))
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'over_all_comparison))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (roslisp-msg-protocol:serialize ele ostream))
   (cl:slot-value msg 'over_all_comparison))
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DomainOperator>) istream)
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'at_start_comparison) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'at_start_comparison)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'rosplan_knowledge_msgs-msg:DomainInequality))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  (cl:let ((__ros_arr_len 0))
    (cl:setf (cl:ldb (cl:byte 8 0) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'at_end_comparison) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'at_end_comparison)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'rosplan_knowledge_msgs-msg:DomainInequality))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'over_all_comparison) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'over_all_comparison)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'rosplan_knowledge_msgs-msg:DomainInequality))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DomainOperator>)))
  ...
  "169396bd4c8278ca06550ef5a062c243")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DomainOperator)))
  "Returns md5sum for a message object of type 'DomainOperator"
  "169396bd4c8278ca06550ef5a062c243")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <DomainOperator>))
  (cl:+ 0
     ...
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'at_start_comparison) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ (roslisp-msg-protocol:serialization-length ele))))
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'at_end_comparison) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ (roslisp-msg-protocol:serialization-length ele))))
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'over_all_comparison) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ (roslisp-msg-protocol:serialization-length ele))))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <DomainOperator>))
  ...
  (cl:list 'DomainOperator
    ...
    (cl:cons ':at_start_comparison (at_start_comparison msg))
    (cl:cons ':at_end_comparison (at_end_comparison msg))
    (cl:cons ':over_all_comparison (over_all_comparison msg))
))
