...
(cl:defmethod cl:initialize-instance :after ((m <CreatePRM-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CreatePRM-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosplan_interface_mapping-srv:<CreatePRM-request> is deprecated: use rosplan_interface_mapping-srv:CreatePRM-request instead.")))

(cl:ensure-generic-function 'nr_waypoints-val :lambda-list '(m))
(cl:defmethod nr_waypoints-val ((m <CreatePRM-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosplan_interface_mapping-srv:nr_waypoints-val is deprecated.  Use rosplan_interface_mapping-srv:nr_waypoints instead.")
  (nr_waypoints m))

(cl:ensure-generic-function 'min_distance-val :lambda-list '(m))
(cl:defmethod min_distance-val ((m <CreatePRM-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosplan_interface_mapping-srv:min_distance-val is deprecated.  Use rosplan_interface_mapping-srv:min_distance instead.")
  (min_distance m))

(cl:ensure-generic-function 'casting_distance-val :lambda-list '(m))
(cl:defmethod casting_distance-val ((m <CreatePRM-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosplan_interface_mapping-srv:casting_distance-val is deprecated.  Use rosplan_interface_mapping-srv:casting_distance instead.")
  (casting_distance m))
...
(cl:defmethod occupancy_threshold-val ((m <CreatePRM-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosplan_interface_mapping-srv:occupancy_threshold-val is deprecated.  Use rosplan_interface_mapping-srv:occupancy_threshold instead.")
...
(cl:defmethod total_attempts-val ((m <CreatePRM-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosplan_interface_mapping-srv:total_attempts-val is deprecated.  Use rosplan_interface_mapping-srv:total_attempts instead.")
  (total_attempts m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CreatePRM-request>)))
  ...
  "rosplan_interface_mapping/CreatePRMRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CreatePRM-request)))
  "Returns string type for a service object of type 'CreatePRM-request"
  "rosplan_interface_mapping/CreatePRMRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <CreatePRM-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CreatePRM-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosplan_interface_mapping-srv:<CreatePRM-response> is deprecated: use rosplan_interface_mapping-srv:CreatePRM-response instead.")))

(cl:ensure-generic-function 'waypoints-val :lambda-list '(m))
(cl:defmethod waypoints-val ((m <CreatePRM-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosplan_interface_mapping-srv:waypoints-val is deprecated.  Use rosplan_interface_mapping-srv:waypoints instead.")
  (waypoints m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CreatePRM-response>)))
  ...
  "rosplan_interface_mapping/CreatePRMResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CreatePRM-response)))
  "Returns string type for a service object of type 'CreatePRM-response"
  "rosplan_interface_mapping/CreatePRMResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CreatePRM)))
  ...
  "rosplan_interface_mapping/CreatePRM")