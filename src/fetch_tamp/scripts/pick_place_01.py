...
class GraspingClient(object):
    ...
    def updateScene(self):
        ...
        for obj in find_result.objects:
            ...
            if obj.object.primitive_poses[0].position.x < 1.5: #< 0.85:
...
#    object_path = os.path.join(pack_path, 'models', 'cracker', 'model0.urdf')
#    object_name = 'cracker'
#    object_pose = Pose(position=Point(x=2.5, y=0, z=1.0))
#    spawn_gazebo_model(object_path, object_name, object_pose)
#    time.sleep(1.0)
